...
def services():
    services_list = [
        ...
        Service("Tracking", "The Formag company has own modern car park, long-term contracts with transport companies."),
        Service("Railway transportation", "Railway delivery is economical and fast. Formag carries out both delivery in Ukraine and cargo transportation from Asia."),
        Service("Warehouse complex", "Formag Forwarding transhipment and storage complex is modern equipment and a team of the best specialists in the industry."),
        Service("Insurance and custom clearance", "Formag is an agent of Megapolis Insurance Partnership, which occupies a leading position in the field of cargo insurance."),
        Service("LTL deliveries", "LTL transportation advantages are obvious: if you need to deliver a small consignment, it will be much more profitable to use consolidated truck and to share transportation charges with other shippers."),
        Service("Port forwarding", "While performing the freight forwarding we constantly notify customers on the matter of their cargos’ status and cooperate with port authorities and customs directly to provide the service of the highest quality."),
    ]
